'''This test.py is just a copy of test.ipynp jupyter notebook. In this file I have written code to just open a file explorer to choose your
input image file, to make it easy for user to select their image file for prediction. '''
